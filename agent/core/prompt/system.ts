 ...
 */
export function buildSystemPrompt(config: AgentConfig, identity: string | null): string {
  ...
  return [
    ...
    `3. Cuando no tengas la información, di exactamente: "${config.refusalPhrase}" y ofrece hablar de otro tema sobre ${name}.`,
