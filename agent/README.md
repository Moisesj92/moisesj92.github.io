...
components/     componentes del template Spotlight, copiados del portafolio
...
Vercel con **Root Directory = `agent`**; Neon como Postgres (el esquema se aplica solo en el primer uso, también en los branches de preview). CI: lint, tests, build y tsc en cada PR; evals bajo demanda mientras la key sea del free tier (comparte cuota con producción).
